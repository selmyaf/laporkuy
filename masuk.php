    ...
    a {
        ...
        <div class="row d-flex">
            <div class="col-lg-4" style="">
                <br><br><h2>Masuk dan Bagikan Cerita Anda Ke Orang Lain</h2><br>
                <a>Lorem ipsum dolor sit amet consectetur. Nulla lorem tempus quis egestas.  </a>
            </div>
            <div class="col-lg-1 offset-lg-1">
                <div class="card1 pb-5">
                    <div class="row px-3 justify-content-center mt-4 mb-5 border-line">
                        <img src="undraw_join_re_w1lh 1.png" class="image">
                    </div>
                </div>
            </div>
            ...
            <form action="prosesmasuk.php" method="post">
                    ...
                    <div class="row mb-3 px-3">
                        <input type="submit"name="masuk" class="btn btn-blue text-center"></input>
                    </div>
            </form>
                    <div class="row px-3 mb-4">
                        <div class="line"></div>
                        <small class="or text-center">Atau Daftar Dengan</small>
                        <div class="line"></div>
                    </div>
                    ...
                    <div class="row mb-4 px-3">
                        <small class="font-weight-bold">Belum Punya Akun? <a class="text-danger " href = "daftar.php">Daftar</a></small>
                    </div>
                </div>
            </div>
        </div>
