...
<div class="container position-relative">
    <div class="bg-holder"
        ...
        <div class="col-12 mx-auto align-items-center text-center py-4">
            ...
            <form action="addaspirasi.php" method="post" enctype="multipart/form-data">
            
                
                <div class="mb-3">
                    <label for="isiaporan" class="form-label">Isi Aspirasi*</label>
                    <textarea class="form-control" id="detailLaporan" name="isiaspirasi" required></textarea>
                </div>
                
                <div class="mb-3">
                    <label for="uploadFile" class="form-label">Unggah Gambar</label>
                    <input type="file" class="form-control" id="uploadFile" name="gambaras" required>
                </div>
                <button type="submit" class="btn " name="privasi" style="Background-color: #006400; color:white;">Kirim Aspirasi</button>
            </form>
        </div>
        </div>
