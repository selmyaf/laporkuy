<?php
    ...
    $email = $_SESSION['email']; 
              ...
              // Menggunakan data pengguna yang telah diambil
              $nik = $akun['nik'];
...
.bg-gradient-default {
  background: linear-gradient(87deg, #172b4d 0, #F55767 100%) !important;
}
...
.timeline {
  ...
  .header {
    overflow: hidden; /* This ensures that the container wraps around the floated elements */
  }
  .status, .actions {
    float: right; /* This will float the elements to the right */
    margin-left: 10px; /* This adds some space between the elements */
  }
  /* Optional: If you want the title to stay on the left, you can float it to the left */
  .title {
    float: left;
  }
</style>
...
<body>
  <div class="main-content">
    ...
    <!-- Header -->
    <div class="header pb-8 pt-5 pt-lg-8 d-flex align-items-center" style="min-height: 200px; background-image: url(Rectangle\ 60.png); background-size: cover; background-position: center top; ">
      <!-- Mask -->
    ...
    <div class="container-fluid mt--7">
      <div class="row">
            ...
            <div class="row justify-content-center">
              <div class="col-lg-3 order-lg-2">
                <div class="card-profile-image">
                  <a href="#">
                    <img src="Ellipse 26.png" class="rounded-circle">
                  </a>
                </div>
              </div>
            </div>
        ...
        <div class="col-xl-8 order-xl-2 ">
                  ...
                  <div class="col">
                    <div class="card-profile-stats d-flex justify-content-center mt-md-1">
                      <div>
                        ...
                        <span class="description">Tunggu</span>
                      </div>
                      <div>
                        <span class="heading">0</span>
                        <span class="description">Proses</span>
                      </div>
                      <div>
            ...
            $query = "SELECT * FROM formulir"; // Ganti 'nama_tabel_laporan' dengan nama tabel yang sesuai
            ...
            $result = mysqli_query($conn, $query);
                ...
                if (mysqli_num_rows($result) > 0) {
                  ...
                  echo '<img src="nolap.png" alt="No data" style="max-width: 100%;">';
                  echo'<br><br>';
                  echo '<h4><p>Tidak ada laporan saat ini!</p></h4>';
                  echo '</div>';
                }
