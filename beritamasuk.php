...
<div class="container py-5">
    <br>
        <h4 class="fw-semibold">Berita Masuk </h4>
        <table class="table table-striped mt-5">
            ...
            $query = "SELECT * FROM berita"; // Ganti 'nama_tabel' dengan nama tabel yang sesuai
            ...
            if (mysqli_num_rows($result) > 0) {
              ...
              <th scope="row"><?php echo $counter; ?></th> <!-- Kolom nomor urutan -->
                ...
                <td><img src="gambar/<?php echo htmlspecialchars($row['gambar']); ?>" alt="Nama Dokumen"  width="100" height="100"></td>
                
                <td>
                <a href="formupberita.php?judulberita=<?php echo $row['judulberita']; ?>">Edit</a> 
                <a href="deleteberita.php?judulberita=<?php echo $row['judulberita']; ?>">Delete</a> 
                <a href="detailberita.php?judulberita=<?php echo $row['judulberita']; ?>">Detail</a> 
