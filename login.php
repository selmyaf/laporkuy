            ...
            <div class="container"><a class="navbar-brand d-flex align-items-center fw-bold fs-2" href="index.html">
                ...
                <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
                    ...
                    <form class="ps-lg-5">
                        ...
                        <button class="btn btn-lg btn-outline-danger rounded-pill order-0" type="submit">Daftar</button>
                    </form>
                </div>
            </div>
        </nav>
            ...
            <div class="container position-relative py-5">
                <div class="row align-items-center py-10">
                    ...
                    <form action="prosesmasuk.php" method="post">
                        ...
                        <center><input type="submit" class="btn btn-lg btn-danger rounded-pill col-6 mx-auto" name="masuk" value="Masuk"></button></center>
                        <center>
                    ...
                    <div class="col-md-7 col-lg-6 text-center text-md-start">
                        <h1 class="mb-4 display-3 fw-bold lh-sm">Masuk dan Bagikan Cerita Anda Ke  <br
